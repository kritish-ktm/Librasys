  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "http://localhost:5000/api/auth/memberlogin",
        {
          email,
      ...
      // Block non-member accounts from this page
      if (res.data.role !== "Member") {
        localStorage.clear();
        setError("Only members can log in from this page.");
        return;
      }
      ...
      <section className="auth-shell">
        ...
        <section className="auth-card" aria-labelledby="member-login-title">
          <div className="auth-card-header">
            ...
            <p>Only member accounts can continue from this page.</p>
          </div>
          ...
          <div className="auth-security-note">
            <ShieldCheck size={18} />
            <span>Admin and librarian accounts are blocked from member login.</span>
          </div>
        </section>
      </section>
    </main>
