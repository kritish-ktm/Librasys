...
-- =============================================================================
-- Book seed (Richart)
-- These records are used to test the Book Management page.
-- =============================================================================

-- Books are inserted with:
-- CategoryID, Title, ISBN, PublicationDate, AvailableCopies, and IsBorrowable.
...
-- Reference books are not borrowable because they should stay inside the library.
